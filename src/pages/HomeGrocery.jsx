...
const topRated = [
  ...
  { id: 3, name: "Natural Blue Berry Fruits", category: "Fruits", price: "$30.00", oldPrice: "$25.00", image: toprated3 },
];

const topSelling = [
  { id: 1, name: "Lemon - Seedless Natural", category: "Vegetables", price: "$45.00", oldPrice: "$42.00", image: topsell1 },
  { id: 2, name: "Mango - Kesar Natural Fruit", category: "Fruits", price: "$65.00", oldPrice: "$62.00", image: topsell2 },
